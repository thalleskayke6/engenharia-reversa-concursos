...
[![Método](https://img.shields.io/badge/m%C3%A9todo-Valter%20Rodrigues-8a3324)](https://www.youtube.com/@ValterRodrigues01)
[![Canal](https://img.shields.io/badge/YouTube-@ValterRodrigues01-FF0000?logo=youtube&logoColor=white)](https://www.youtube.com/@ValterRodrigues01)
[![Licença](https://img.shields.io/badge/texto-CC%20BY%204.0-7a736a)](LICENSE)
...
| 11 | [Inteligência artificial aplicada](#11-inteligência-artificial-aplicada) | O fluxo das Aulas 01 e 02 e os dois prompts |
...
mindmap
  root((Método))
    Especificidade
      Treino imita a prova
      Filtro pela banca do certame
    Engenharia reversa
      Teoria alfabetiza
      Questão ensina
    Constância
      ...
      Todos os dias
    Estabilidade
      Mesmo método por 6 meses
      Sem trocar de professor
    Recuperação ativa
      Algoritmo decide o quando
      Humano faz o esforço
    Cobertor curto
      Peso x incidência
...
```mermaid
flowchart LR
    A["Camada 1<br/>Teoria mínima<br/>10 a 15 min"] --> B["Camada 2<br/>Questões filtradas<br/>90 a 95% do tempo"]
    B --> C{Resultado}
    C -->|Acertou com convicção| D["Avança<br/>sem card"]
    C -->|Acertou por sorte| E["Trata como erro"]
    C -->|Errou| E
    E --> F["Camada 3<br/>Card no Anki<br/>25 a 40 min por dia"]
    F --> G["Revisão espaçada<br/>automática"]
    D --> B
    G --> B
```
...
```mermaid
flowchart TD
    A["1. Erro ou acerto por sorte<br/>na plataforma"] --> B["2. Copiar o comentário do professor<br/>ou o texto literal da lei"]
    B --> C["3. Colar prompt-mestre + excerto<br/>e nada além disso"]
    C --> D["4. IA gera o item sob a regra<br/>da verdade absoluta"]
    D --> E["5. Importar no Anki"]
    E --> F["6. Revisão espaçada automática"]
```
...
| Módulo | O que faz | Qual falha ele corrige |
|---|---|---|
...
A saída sai em três camadas, na ordem de uso. A camada 1 é texto corrido no chat, para você validar o item antes de importar qualquer coisa. A camada 2 é o HTML da frente. A camada 3 é o HTML do verso, com o trecho matador sobre a faixa âmbar, a linha do gatilho em roxo e o rodapé cinza com matéria e código da pegadinha.

Para um card avulso, copie as camadas 2 e 3 e cole pelo editor de HTML do campo, com `Ctrl + Shift + X`, como descrito em [10.5](#105-se-o-cartão-tem-html). Para um lote, monte o arquivo com frente, tabulação, verso, tabulação e etiquetas, e importe marcando "Permitir HTML nos campos", conforme [10.6](#106-importação-em-lote).

Uma sugestão de etiqueta que aproveita o catálogo: além da matéria e da lei, marque o código da pegadinha, como `p5_prazo` ou `p9_deslocamento`. Depois de algumas semanas, um baralho filtrado por um desses códigos te devolve exatamente o mecanismo pelo qual você mais cai.
